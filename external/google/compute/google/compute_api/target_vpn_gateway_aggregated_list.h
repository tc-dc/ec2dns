...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetVpnGatewayAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static TargetVpnGatewayAggregatedList* New();
   ...
   */
  explicit TargetVpnGatewayAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetVpnGatewayAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetVpnGatewayAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetVpnGatewayAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetVpnGatewayAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<TargetVpnGatewaysScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<TargetVpnGatewaysScopedList > mutable_items();
 ...
 private:
  void operator=(const TargetVpnGatewayAggregatedList&);
};  // TargetVpnGatewayAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_AGGREGATED_LIST_H_
