...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceAggregatedList* New();
   ...
   */
  explicit InstanceAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<InstancesScopedList > get_items() const {
    const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppAssociativeArray<InstancesScopedList>>(storage);
  }
   ...
   */
  client::JsonCppAssociativeArray<InstancesScopedList > mutable_items();
 ...
 private:
  void operator=(const InstanceAggregatedList&);
};  // InstanceAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_AGGREGATED_LIST_H_
