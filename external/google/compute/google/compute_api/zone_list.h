...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ZONE_LIST_H_
#define  GOOGLE_COMPUTE_API_ZONE_LIST_H_
 ...
 * @ingroup DataObject
 */
class ZoneList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ZoneList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ZoneList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::ZoneList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ZoneList");
  }
   ...
   */
  const client::JsonCppArray<Zone > get_items() const {
    const Json::Value &storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<Zone>>(storage);
  }
   ...
   */
  client::JsonCppArray<Zone > mutable_items();
 ...
 private:
  void operator=(const ZoneList&);
};  // ZoneList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ZONE_LIST_H_
