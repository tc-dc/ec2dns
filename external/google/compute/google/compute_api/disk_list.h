...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_DISK_LIST_H_
#define  GOOGLE_COMPUTE_API_DISK_LIST_H_
 ...
 * @ingroup DataObject
 */
class DiskList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit DiskList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit DiskList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::DiskList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::DiskList");
  }
   ...
   */
  const client::JsonCppArray<Disk > get_items() const;
   ...
   */
  client::JsonCppArray<Disk > mutable_items();
 ...
 private:
  void operator=(const DiskList&);
};  // DiskList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_DISK_LIST_H_
