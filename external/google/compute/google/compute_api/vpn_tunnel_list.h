...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_VPN_TUNNEL_LIST_H_
#define  GOOGLE_COMPUTE_API_VPN_TUNNEL_LIST_H_
 ...
 * @ingroup DataObject
 */
class VpnTunnelList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit VpnTunnelList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VpnTunnelList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::VpnTunnelList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::VpnTunnelList");
  }
   ...
   */
  const client::JsonCppArray<VpnTunnel > get_items() const;
   ...
   */
  client::JsonCppArray<VpnTunnel > mutable_items();
 ...
 private:
  void operator=(const VpnTunnelList&);
};  // VpnTunnelList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_VPN_TUNNEL_LIST_H_
