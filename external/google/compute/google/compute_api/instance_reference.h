...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_REFERENCE_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_REFERENCE_H_
 ...
 * @ingroup DataObject
 */
class InstanceReference : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit InstanceReference(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceReference(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::InstanceReference</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceReference");
  }
 ...
 private:
  void operator=(const InstanceReference&);
};  // InstanceReference
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_REFERENCE_H_
