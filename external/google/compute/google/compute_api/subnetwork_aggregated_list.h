...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SUBNETWORK_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_SUBNETWORK_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class SubnetworkAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static SubnetworkAggregatedList* New();
   ...
   */
  explicit SubnetworkAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SubnetworkAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SubnetworkAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::SubnetworkAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SubnetworkAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<SubnetworksScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<SubnetworksScopedList > mutable_items();
 ...
 private:
  void operator=(const SubnetworkAggregatedList&);
};  // SubnetworkAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SUBNETWORK_AGGREGATED_LIST_H_
