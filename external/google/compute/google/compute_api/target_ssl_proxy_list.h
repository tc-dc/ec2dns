...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_SSL_PROXY_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_SSL_PROXY_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetSslProxyList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetSslProxyList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetSslProxyList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetSslProxyList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetSslProxyList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetSslProxyList");
  }
   ...
   */
  const client::JsonCppArray<TargetSslProxy > get_items() const;
   ...
   */
  client::JsonCppArray<TargetSslProxy > mutable_items();
 ...
 private:
  void operator=(const TargetSslProxyList&);
};  // TargetSslProxyList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_SSL_PROXY_LIST_H_
