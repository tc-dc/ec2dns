...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_OPERATION_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_OPERATION_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class OperationAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static OperationAggregatedList* New();
   ...
   */
  explicit OperationAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit OperationAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~OperationAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::OperationAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::OperationAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<OperationsScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<OperationsScopedList > mutable_items();
 ...
 private:
  void operator=(const OperationAggregatedList&);
};  // OperationAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_OPERATION_AGGREGATED_LIST_H_
