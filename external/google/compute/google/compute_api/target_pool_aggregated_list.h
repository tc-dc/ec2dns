...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_POOL_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_POOL_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetPoolAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static TargetPoolAggregatedList* New();
   ...
   */
  explicit TargetPoolAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetPoolAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetPoolAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetPoolAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetPoolAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<TargetPoolsScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<TargetPoolsScopedList > mutable_items();
 ...
 private:
  void operator=(const TargetPoolAggregatedList&);
};  // TargetPoolAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_POOL_AGGREGATED_LIST_H_
