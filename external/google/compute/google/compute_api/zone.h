...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ZONE_H_
#define  GOOGLE_COMPUTE_API_ZONE_H_
 ...
 * @ingroup DataObject
 */
class Zone : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Zone(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Zone(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::Zone</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::Zone");
  }
...
#endif  // GOOGLE_COMPUTE_API_ZONE_H_
