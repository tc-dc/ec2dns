...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ADDRESS_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_ADDRESS_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class AddressAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static AddressAggregatedList* New();
   ...
   */
  explicit AddressAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AddressAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~AddressAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::AddressAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::AddressAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<AddressesScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<AddressesScopedList > mutable_items();
 ...
 private:
  void operator=(const AddressAggregatedList&);
};  // AddressAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ADDRESS_AGGREGATED_LIST_H_
