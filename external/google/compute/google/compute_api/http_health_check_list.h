...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_HTTP_HEALTH_CHECK_LIST_H_
#define  GOOGLE_COMPUTE_API_HTTP_HEALTH_CHECK_LIST_H_
 ...
 * @ingroup DataObject
 */
class HttpHealthCheckList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static HttpHealthCheckList* New();
   ...
   */
  explicit HttpHealthCheckList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit HttpHealthCheckList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~HttpHealthCheckList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::HttpHealthCheckList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::HttpHealthCheckList");
  }
   ...
   */
  const client::JsonCppArray<HttpHealthCheck > get_items() const;
   ...
   */
  client::JsonCppArray<HttpHealthCheck > mutable_items();
 ...
 private:
  void operator=(const HttpHealthCheckList&);
};  // HttpHealthCheckList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_HTTP_HEALTH_CHECK_LIST_H_
