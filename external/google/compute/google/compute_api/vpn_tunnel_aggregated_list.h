...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_VPN_TUNNEL_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_VPN_TUNNEL_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class VpnTunnelAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static VpnTunnelAggregatedList* New();
   ...
   */
  explicit VpnTunnelAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VpnTunnelAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~VpnTunnelAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::VpnTunnelAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::VpnTunnelAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<VpnTunnelsScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<VpnTunnelsScopedList > mutable_items();
 ...
 private:
  void operator=(const VpnTunnelAggregatedList&);
};  // VpnTunnelAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_VPN_TUNNEL_AGGREGATED_LIST_H_
