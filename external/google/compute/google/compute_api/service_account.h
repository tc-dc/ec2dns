...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SERVICE_ACCOUNT_H_
#define  GOOGLE_COMPUTE_API_SERVICE_ACCOUNT_H_
...
class ServiceAccount : public client::JsonCppData {
 public:
   ...
   *
   * @return <code>google_compute_api::ServiceAccount</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ServiceAccount");
  }
...
#endif  // GOOGLE_COMPUTE_API_SERVICE_ACCOUNT_H_
