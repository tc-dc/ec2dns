...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetHttpsProxyList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static TargetHttpsProxyList* New();
   ...
   */
  explicit TargetHttpsProxyList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetHttpsProxyList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetHttpsProxyList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetHttpsProxyList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetHttpsProxyList");
  }
   ...
   */
  const client::JsonCppArray<TargetHttpsProxy > get_items() const;
   ...
   */
  client::JsonCppArray<TargetHttpsProxy > mutable_items();
 ...
 private:
  void operator=(const TargetHttpsProxyList&);
};  // TargetHttpsProxyList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_LIST_H_
