...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_URL_MAP_LIST_H_
#define  GOOGLE_COMPUTE_API_URL_MAP_LIST_H_
 ...
 * @ingroup DataObject
 */
class UrlMapList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit UrlMapList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit UrlMapList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::UrlMapList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::UrlMapList");
  }
   ...
   */
  const client::JsonCppArray<UrlMap > get_items() const;
   ...
   */
  client::JsonCppArray<UrlMap > mutable_items();
 ...
 private:
  void operator=(const UrlMapList&);
};  // UrlMapList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_URL_MAP_LIST_H_
