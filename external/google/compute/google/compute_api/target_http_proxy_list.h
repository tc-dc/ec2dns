...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_HTTP_PROXY_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_HTTP_PROXY_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetHttpProxyList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static TargetHttpProxyList* New();
   ...
   */
  explicit TargetHttpProxyList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetHttpProxyList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetHttpProxyList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetHttpProxyList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetHttpProxyList");
  }
   ...
   */
  const client::JsonCppArray<TargetHttpProxy > get_items() const;
   ...
   */
  client::JsonCppArray<TargetHttpProxy > mutable_items();
 ...
 private:
  void operator=(const TargetHttpProxyList&);
};  // TargetHttpProxyList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_HTTP_PROXY_LIST_H_
