...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_LIST_INSTANCES_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_LIST_INSTANCES_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupsListInstances : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceGroupsListInstances* New();
   ...
   */
  explicit InstanceGroupsListInstances(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupsListInstances(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceGroupsListInstances();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupsListInstances</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupsListInstances");
  }
 ...
 private:
  void operator=(const InstanceGroupsListInstances&);
};  // InstanceGroupsListInstances
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUPS_LIST_INSTANCES_H_
