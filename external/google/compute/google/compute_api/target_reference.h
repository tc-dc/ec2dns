...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_REFERENCE_H_
#define  GOOGLE_COMPUTE_API_TARGET_REFERENCE_H_
 ...
 * @ingroup DataObject
 */
class TargetReference : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetReference(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetReference(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::TargetReference</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetReference");
  }
 ...
 private:
  void operator=(const TargetReference&);
};  // TargetReference
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_REFERENCE_H_
