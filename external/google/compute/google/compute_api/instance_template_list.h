...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_TEMPLATE_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_TEMPLATE_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceTemplateList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceTemplateList* New();
   ...
   */
  explicit InstanceTemplateList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceTemplateList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceTemplateList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceTemplateList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceTemplateList");
  }
   ...
   */
  const client::JsonCppArray<InstanceTemplate > get_items() const;
   ...
   */
  client::JsonCppArray<InstanceTemplate > mutable_items();
 ...
 private:
  void operator=(const InstanceTemplateList&);
};  // InstanceTemplateList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_TEMPLATE_LIST_H_
