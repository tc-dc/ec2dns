...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_REGION_AUTOSCALER_LIST_H_
#define  GOOGLE_COMPUTE_API_REGION_AUTOSCALER_LIST_H_
 ...
 * @ingroup DataObject
 */
class RegionAutoscalerList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static RegionAutoscalerList* New();
   ...
   */
  explicit RegionAutoscalerList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RegionAutoscalerList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~RegionAutoscalerList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::RegionAutoscalerList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RegionAutoscalerList");
  }
   ...
   */
  const client::JsonCppArray<Autoscaler > get_items() const;
   ...
   */
  client::JsonCppArray<Autoscaler > mutable_items();
 ...
 private:
  void operator=(const RegionAutoscalerList&);
};  // RegionAutoscalerList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_REGION_AUTOSCALER_LIST_H_
