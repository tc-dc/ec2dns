...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SSLH_EALTH_CHECK_H_
#define  GOOGLE_COMPUTE_API_SSLH_EALTH_CHECK_H_
 ...
 * @ingroup DataObject
 */
class SSLHealthCheck : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SSLHealthCheck(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SSLHealthCheck(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::SSLHealthCheck</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SSLHealthCheck");
  }
 ...
 private:
  void operator=(const SSLHealthCheck&);
};  // SSLHealthCheck
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SSLH_EALTH_CHECK_H_
