...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SUBNETWORK_LIST_H_
#define  GOOGLE_COMPUTE_API_SUBNETWORK_LIST_H_
 ...
 * @ingroup DataObject
 */
class SubnetworkList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SubnetworkList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SubnetworkList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SubnetworkList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::SubnetworkList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SubnetworkList");
  }
   ...
   */
  const client::JsonCppArray<Subnetwork > get_items() const;
   ...
   */
  client::JsonCppArray<Subnetwork > mutable_items();
 ...
 private:
  void operator=(const SubnetworkList&);
};  // SubnetworkList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SUBNETWORK_LIST_H_
