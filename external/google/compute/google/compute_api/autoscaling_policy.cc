...
AutoscalingPolicy* AutoscalingPolicy::New() {
  return new client::JsonCppCapsule<AutoscalingPolicy>;
}

// Standard immutable constructor.
AutoscalingPolicy::AutoscalingPolicy(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
AutoscalingPolicy::AutoscalingPolicy(Json::Value* storage)
  : client::JsonCppData(storage) {
}
