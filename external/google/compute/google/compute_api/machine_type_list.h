...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_MACHINE_TYPE_LIST_H_
#define  GOOGLE_COMPUTE_API_MACHINE_TYPE_LIST_H_
 ...
 * @ingroup DataObject
 */
class MachineTypeList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit MachineTypeList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit MachineTypeList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~MachineTypeList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::MachineTypeList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::MachineTypeList");
  }
   ...
   */
  const client::JsonCppArray<MachineType > get_items() const;
   ...
   */
  client::JsonCppArray<MachineType > mutable_items();
 ...
 private:
  void operator=(const MachineTypeList&);
};  // MachineTypeList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_MACHINE_TYPE_LIST_H_
