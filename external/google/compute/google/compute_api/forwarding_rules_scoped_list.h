...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_FORWARDING_RULES_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_FORWARDING_RULES_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class ForwardingRulesScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class ForwardingRulesScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class ForwardingRulesScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static ForwardingRulesScopedListWarningData* New();
       ...
       */
      explicit ForwardingRulesScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit ForwardingRulesScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~ForwardingRulesScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return
       * <code>google_compute_api::ForwardingRulesScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::ForwardingRulesScopedListWarningData");
      }
     ...
     private:
      void operator=(const ForwardingRulesScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static ForwardingRulesScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit ForwardingRulesScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit ForwardingRulesScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~ForwardingRulesScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::ForwardingRulesScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::ForwardingRulesScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<ForwardingRulesScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<ForwardingRulesScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<ForwardingRulesScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<ForwardingRulesScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const ForwardingRulesScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static ForwardingRulesScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ForwardingRulesScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ForwardingRulesScopedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ForwardingRulesScopedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::ForwardingRulesScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ForwardingRulesScopedList");
  }

  /**
   * Determine if the '<code>forwardingRules</code>' attribute was set.
   *
   * @return true if the '<code>forwardingRules</code>' attribute was set.
   */
  bool has_forwarding_rules() const {
    return Storage().isMember("forwardingRules");
  }

  /**
   * Clears the '<code>forwardingRules</code>' attribute.
   */
  void clear_forwarding_rules() {
    MutableStorage()->removeMember("forwardingRules");
  }


  /**
   * Get a reference to the value of the '<code>forwardingRules</code>'
   * attribute.
   */
  const client::JsonCppArray<ForwardingRule > get_forwarding_rules() const;

  /**
   * Gets a reference to a mutable value of the '<code>forwardingRules</code>'
   * property.
   *
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<ForwardingRule > mutable_forwardingRules();
   ...
   */
  const ForwardingRulesScopedListWarning get_warning() const {
     const Json::Value& storage = Storage("warning");
    return client::JsonValueToCppValueHelper<ForwardingRulesScopedListWarning >(storage);
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  ForwardingRulesScopedListWarning mutable_warning() {
    Json::Value* storage = MutableStorage("warning");
    return client::JsonValueToMutableCppValueHelper<ForwardingRulesScopedListWarning >(storage);
  }

 private:
  void operator=(const ForwardingRulesScopedList&);
};  // ForwardingRulesScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_FORWARDING_RULES_SCOPED_LIST_H_
