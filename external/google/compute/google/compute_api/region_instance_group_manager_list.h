...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_MANAGER_LIST_H_
#define  GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_MANAGER_LIST_H_
 ...
 * @ingroup DataObject
 */
class RegionInstanceGroupManagerList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static RegionInstanceGroupManagerList* New();
   ...
   */
  explicit RegionInstanceGroupManagerList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RegionInstanceGroupManagerList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~RegionInstanceGroupManagerList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::RegionInstanceGroupManagerList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RegionInstanceGroupManagerList");
  }
   ...
   */
  const client::JsonCppArray<InstanceGroupManager > get_items() const;
   ...
   */
  client::JsonCppArray<InstanceGroupManager > mutable_items();
 ...
 private:
  void operator=(const RegionInstanceGroupManagerList&);
};  // RegionInstanceGroupManagerList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_MANAGER_LIST_H_
