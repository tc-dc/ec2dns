...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_DISK_TYPE_LIST_H_
#define  GOOGLE_COMPUTE_API_DISK_TYPE_LIST_H_
 ...
 * @ingroup DataObject
 */
class DiskTypeList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit DiskTypeList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit DiskTypeList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~DiskTypeList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::DiskTypeList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::DiskTypeList");
  }
   ...
   */
  const client::JsonCppArray<DiskType > get_items() const;
   ...
   */
  client::JsonCppArray<DiskType > mutable_items();
 ...
 private:
  void operator=(const DiskTypeList&);
};  // DiskTypeList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_DISK_TYPE_LIST_H_
