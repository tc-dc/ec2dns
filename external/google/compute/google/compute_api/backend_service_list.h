...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_BACKEND_SERVICE_LIST_H_
#define  GOOGLE_COMPUTE_API_BACKEND_SERVICE_LIST_H_
 ...
 * @ingroup DataObject
 */
class BackendServiceList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit BackendServiceList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit BackendServiceList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~BackendServiceList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::BackendServiceList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::BackendServiceList");
  }
   ...
   */
  const client::JsonCppArray<BackendService > get_items() const;
   ...
   */
  client::JsonCppArray<BackendService > mutable_items();
 ...
 private:
  void operator=(const BackendServiceList&);
};  // BackendServiceList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_BACKEND_SERVICE_LIST_H_
