...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUP_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUP_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit InstanceGroupList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::InstanceGroupList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupList");
  }
 ...
 private:
  void operator=(const InstanceGroupList&);
};  // InstanceGroupList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUP_LIST_H_
