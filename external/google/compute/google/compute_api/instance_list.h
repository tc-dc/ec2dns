...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit InstanceList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::InstanceList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceList");
  }
   ...
   */
  const client::JsonCppArray<Instance > get_items() const {
   ...
   */
  client::JsonCppArray<Instance > mutable_items();
 ...
 private:
  void operator=(const InstanceList&);
};  // InstanceList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_LIST_H_
