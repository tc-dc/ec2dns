...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_MACHINE_TYPES_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_MACHINE_TYPES_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class MachineTypesScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class MachineTypesScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class MachineTypesScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static MachineTypesScopedListWarningData* New();
       ...
       */
      explicit MachineTypesScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit MachineTypesScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~MachineTypesScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return
       * <code>google_compute_api::MachineTypesScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::MachineTypesScopedListWarningData");
      }
     ...
     private:
      void operator=(const MachineTypesScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static MachineTypesScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit MachineTypesScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit MachineTypesScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~MachineTypesScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::MachineTypesScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::MachineTypesScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<MachineTypesScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<MachineTypesScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<MachineTypesScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<MachineTypesScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const MachineTypesScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static MachineTypesScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit MachineTypesScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit MachineTypesScopedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~MachineTypesScopedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::MachineTypesScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::MachineTypesScopedList");
  }

  /**
   * Determine if the '<code>machineTypes</code>' attribute was set.
   *
   * @return true if the '<code>machineTypes</code>' attribute was set.
   */
  bool has_machine_types() const {
    return Storage().isMember("machineTypes");
  }

  /**
   * Clears the '<code>machineTypes</code>' attribute.
   */
  void clear_machine_types() {
    MutableStorage()->removeMember("machineTypes");
  }


  /**
   * Get a reference to the value of the '<code>machineTypes</code>' attribute.
   */
  const client::JsonCppArray<MachineType > get_machine_types() const;

  /**
   * Gets a reference to a mutable value of the '<code>machineTypes</code>'
   * property.
   *
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<MachineType > mutable_machineTypes();
   ...
   */
  const MachineTypesScopedListWarning get_warning() const {
     const Json::Value& storage = Storage("warning");
    return client::JsonValueToCppValueHelper<MachineTypesScopedListWarning >(storage);
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  MachineTypesScopedListWarning mutable_warning() {
    Json::Value* storage = MutableStorage("warning");
    return client::JsonValueToMutableCppValueHelper<MachineTypesScopedListWarning >(storage);
  }

 private:
  void operator=(const MachineTypesScopedList&);
};  // MachineTypesScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_MACHINE_TYPES_SCOPED_LIST_H_
