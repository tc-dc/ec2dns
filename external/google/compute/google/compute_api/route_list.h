...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ROUTE_LIST_H_
#define  GOOGLE_COMPUTE_API_ROUTE_LIST_H_
 ...
 * @ingroup DataObject
 */
class RouteList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit RouteList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RouteList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::RouteList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RouteList");
  }
   ...
   */
  const client::JsonCppArray<Route > get_items() const;
   ...
   */
  client::JsonCppArray<Route > mutable_items();
 ...
 private:
  void operator=(const RouteList&);
};  // RouteList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ROUTE_LIST_H_
