...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SSL_CERTIFICATE_H_
#define  GOOGLE_COMPUTE_API_SSL_CERTIFICATE_H_
 ...
 * @ingroup DataObject
 */
class SslCertificate : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SslCertificate(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SslCertificate(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::SslCertificate</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SslCertificate");
  }

  /**
   * Determine if the '<code>certificate</code>' attribute was set.
   *
   * @return true if the '<code>certificate</code>' attribute was set.
   */
  bool has_certificate() const {
    return Storage().isMember("certificate");
  }

  /**
   * Clears the '<code>certificate</code>' attribute.
   */
  void clear_certificate() {
    MutableStorage()->removeMember("certificate");
  }


  /**
   * Get the value of the '<code>certificate</code>' attribute.
   */
  const StringPiece get_certificate() const {
    const Json::Value& v = Storage("certificate");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>certificate</code>' attribute.
   *
   ...
   */
  void set_certificate(const StringPiece& value) {
    *MutableStorage("certificate") = value.data();
  }
  ...
  /**
   * Determine if the '<code>privateKey</code>' attribute was set.
   *
   * @return true if the '<code>privateKey</code>' attribute was set.
   */
  bool has_private_key() const {
    return Storage().isMember("privateKey");
  }

  /**
   * Clears the '<code>privateKey</code>' attribute.
   */
  void clear_private_key() {
    MutableStorage()->removeMember("privateKey");
  }


  /**
   * Get the value of the '<code>privateKey</code>' attribute.
   */
  const StringPiece get_private_key() const {
    const Json::Value& v = Storage("privateKey");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>privateKey</code>' attribute.
   *
   ...
   * @param[in] value The new value.
   */
  void set_private_key(const StringPiece& value) {
    *MutableStorage("privateKey") = value.data();
  }
 ...
 private:
  void operator=(const SslCertificate&);
};  // SslCertificate
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SSL_CERTIFICATE_H_
