...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_AUTOSCALER_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_AUTOSCALER_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class AutoscalerAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static AutoscalerAggregatedList* New();
   ...
   */
  explicit AutoscalerAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AutoscalerAggregatedList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::AutoscalerAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::AutoscalerAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<AutoscalersScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<AutoscalersScopedList > mutable_items();
 ...
 private:
  void operator=(const AutoscalerAggregatedList&);
};  // AutoscalerAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_AUTOSCALER_AGGREGATED_LIST_H_
