...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_REGION_LIST_H_
#define  GOOGLE_COMPUTE_API_REGION_LIST_H_
 ...
 * @ingroup DataObject
 */
class RegionList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit RegionList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RegionList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::RegionList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RegionList");
  }
   ...
   */
  const client::JsonCppArray<Region > get_items() const;
   ...
   */
  client::JsonCppArray<Region > mutable_items();
 ...
 private:
  void operator=(const RegionList&);
};  // RegionList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_REGION_LIST_H_
