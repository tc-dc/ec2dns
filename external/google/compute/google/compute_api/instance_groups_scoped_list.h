...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupsScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class InstanceGroupsScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class InstanceGroupsScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static InstanceGroupsScopedListWarningData* New();
       ...
       */
      explicit InstanceGroupsScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit InstanceGroupsScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~InstanceGroupsScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return
       * <code>google_compute_api::InstanceGroupsScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::InstanceGroupsScopedListWarningData");
      }
     ...
     private:
      void operator=(const InstanceGroupsScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static InstanceGroupsScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstanceGroupsScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstanceGroupsScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~InstanceGroupsScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::InstanceGroupsScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::InstanceGroupsScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<InstanceGroupsScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<InstanceGroupsScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<InstanceGroupsScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<InstanceGroupsScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const InstanceGroupsScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static InstanceGroupsScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupsScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupsScopedList(Json::Value* storage);
   ...
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupsScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupsScopedList");
  }

  /**
   * Determine if the '<code>instanceGroups</code>' attribute was set.
   *
   * @return true if the '<code>instanceGroups</code>' attribute was set.
   */
  bool has_instance_groups() const {
    return Storage().isMember("instanceGroups");
  }

  /**
   * Clears the '<code>instanceGroups</code>' attribute.
   */
  void clear_instance_groups() {
    MutableStorage()->removeMember("instanceGroups");
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<InstanceGroup > mutable_instanceGroups();
  ...
  const InstanceGroupsScopedListWarning get_warning() const {
    ...
    return client::JsonValueToCppValueHelper<InstanceGroupsScopedListWarning >(storage);
  }
  ...
  InstanceGroupsScopedListWarning mutable_warning() {
    ...
    return client::JsonValueToMutableCppValueHelper<InstanceGroupsScopedListWarning >(storage);
  }

 private:
  void operator=(const InstanceGroupsScopedList&);
};  // InstanceGroupsScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SCOPED_LIST_H_
