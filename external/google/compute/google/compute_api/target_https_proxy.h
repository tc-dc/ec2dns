...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_H_
#define  GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_H_
 ...
 * @ingroup DataObject
 */
class TargetHttpsProxy : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetHttpsProxy(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetHttpsProxy(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::TargetHttpsProxy</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetHttpsProxy");
  }
 ...
 private:
  void operator=(const TargetHttpsProxy&);
};  // TargetHttpsProxy
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_HTTPS_PROXY_H_
