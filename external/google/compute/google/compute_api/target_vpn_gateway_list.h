...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetVpnGatewayList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static TargetVpnGatewayList* New();
   ...
   */
  explicit TargetVpnGatewayList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetVpnGatewayList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetVpnGatewayList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetVpnGatewayList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetVpnGatewayList");
  }
   ...
   */
  const client::JsonCppArray<TargetVpnGateway > get_items() const;
   ...
   */
  client::JsonCppArray<TargetVpnGateway > mutable_items();
 ...
 private:
  void operator=(const TargetVpnGatewayList&);
};  // TargetVpnGatewayList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_LIST_H_
