...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ADDRESSES_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_ADDRESSES_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class AddressesScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class AddressesScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class AddressesScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static AddressesScopedListWarningData* New();
       ...
       */
      explicit AddressesScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit AddressesScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~AddressesScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return <code>google_compute_api::AddressesScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::AddressesScopedListWarningData");
      }
     ...
     private:
      void operator=(const AddressesScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static AddressesScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit AddressesScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit AddressesScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~AddressesScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::AddressesScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::AddressesScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<AddressesScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<AddressesScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<AddressesScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<AddressesScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const AddressesScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static AddressesScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AddressesScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AddressesScopedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~AddressesScopedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::AddressesScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::AddressesScopedList");
  }

  /**
   * Determine if the '<code>addresses</code>' attribute was set.
   *
   * @return true if the '<code>addresses</code>' attribute was set.
   */
  bool has_addresses() const {
    return Storage().isMember("addresses");
  }

  /**
   * Clears the '<code>addresses</code>' attribute.
   */
  void clear_addresses() {
    MutableStorage()->removeMember("addresses");
  }


  /**
   * Get a reference to the value of the '<code>addresses</code>' attribute.
   */
  const client::JsonCppArray<Address > get_addresses() const;

  /**
   * Gets a reference to a mutable value of the '<code>addresses</code>'
   * property.
   *
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<Address > mutable_addresses();
   ...
   */
  const AddressesScopedListWarning get_warning() const {
     const Json::Value& storage = Storage("warning");
    return client::JsonValueToCppValueHelper<AddressesScopedListWarning >(storage);
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  AddressesScopedListWarning mutable_warning() {
    Json::Value* storage = MutableStorage("warning");
    return client::JsonValueToMutableCppValueHelper<AddressesScopedListWarning >(storage);
  }

 private:
  void operator=(const AddressesScopedList&);
};  // AddressesScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ADDRESSES_SCOPED_LIST_H_
