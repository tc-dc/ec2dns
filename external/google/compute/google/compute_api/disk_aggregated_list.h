...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_DISK_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_DISK_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class DiskAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit DiskAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit DiskAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~DiskAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::DiskAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::DiskAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<DisksScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<DisksScopedList > mutable_items();
 ...
 private:
  void operator=(const DiskAggregatedList&);
};  // DiskAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_DISK_AGGREGATED_LIST_H_
