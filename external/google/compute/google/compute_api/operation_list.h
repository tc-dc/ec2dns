...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_OPERATION_LIST_H_
#define  GOOGLE_COMPUTE_API_OPERATION_LIST_H_
 ...
 * @ingroup DataObject
 */
class OperationList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit OperationList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit OperationList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::OperationList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::OperationList");
  }
   ...
   */
  const client::JsonCppArray<Operation > get_items() const;
   ...
   */
  client::JsonCppArray<Operation > mutable_items();
 ...
 private:
  void operator=(const OperationList&);
};  // OperationList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_OPERATION_LIST_H_
