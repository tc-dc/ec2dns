...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_POOLS_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_POOLS_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetPoolsScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class TargetPoolsScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class TargetPoolsScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static TargetPoolsScopedListWarningData* New();
       ...
       */
      explicit TargetPoolsScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit TargetPoolsScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~TargetPoolsScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return
       * <code>google_compute_api::TargetPoolsScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::TargetPoolsScopedListWarningData");
      }
     ...
     private:
      void operator=(const TargetPoolsScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static TargetPoolsScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit TargetPoolsScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit TargetPoolsScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~TargetPoolsScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::TargetPoolsScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::TargetPoolsScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<TargetPoolsScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<TargetPoolsScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<TargetPoolsScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<TargetPoolsScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const TargetPoolsScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static TargetPoolsScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetPoolsScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetPoolsScopedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetPoolsScopedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetPoolsScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetPoolsScopedList");
  }
   ...
   */
  const client::JsonCppArray<TargetPool > get_target_pools() const;
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<TargetPool > mutable_targetPools();
   ...
   */
  const TargetPoolsScopedListWarning get_warning() const {
     const Json::Value& storage = Storage("warning");
    return client::JsonValueToCppValueHelper<TargetPoolsScopedListWarning >(storage);
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  TargetPoolsScopedListWarning mutable_warning() {
    Json::Value* storage = MutableStorage("warning");
    return client::JsonValueToMutableCppValueHelper<TargetPoolsScopedListWarning >(storage);
  }

 private:
  void operator=(const TargetPoolsScopedList&);
};  // TargetPoolsScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_POOLS_SCOPED_LIST_H_
