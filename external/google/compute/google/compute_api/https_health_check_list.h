...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_HTTPS_HEALTH_CHECK_LIST_H_
#define  GOOGLE_COMPUTE_API_HTTPS_HEALTH_CHECK_LIST_H_
 ...
 * @ingroup DataObject
 */
class HttpsHealthCheckList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static HttpsHealthCheckList* New();
   ...
   */
  explicit HttpsHealthCheckList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit HttpsHealthCheckList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~HttpsHealthCheckList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::HttpsHealthCheckList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::HttpsHealthCheckList");
  }
   ...
   */
  const client::JsonCppArray<HttpsHealthCheck > get_items() const;
   ...
   */
  client::JsonCppArray<HttpsHealthCheck > mutable_items();
 ...
 private:
  void operator=(const HttpsHealthCheckList&);
};  // HttpsHealthCheckList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_HTTPS_HEALTH_CHECK_LIST_H_
