...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUP_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUP_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceGroupAggregatedList* New();
   ...
   */
  explicit InstanceGroupAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceGroupAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupAggregatedList");
  }
   ...
   */
  client::JsonCppAssociativeArray<InstanceGroupsScopedList > mutable_items();
 ...
 private:
  void operator=(const InstanceGroupAggregatedList&);
};  // InstanceGroupAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUP_AGGREGATED_LIST_H_
