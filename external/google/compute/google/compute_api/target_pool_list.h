...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_POOL_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_POOL_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetPoolList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetPoolList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetPoolList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetPoolList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetPoolList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetPoolList");
  }
   ...
   */
  const client::JsonCppArray<TargetPool > get_items() const;
   ...
   */
  client::JsonCppArray<TargetPool > mutable_items();
 ...
 private:
  void operator=(const TargetPoolList&);
};  // TargetPoolList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_POOL_LIST_H_
