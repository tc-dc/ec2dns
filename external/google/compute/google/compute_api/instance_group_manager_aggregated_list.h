...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupManagerAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceGroupManagerAggregatedList* New();
   ...
   */
  explicit InstanceGroupManagerAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupManagerAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceGroupManagerAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupManagerAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupManagerAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<InstanceGroupManagersScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<InstanceGroupManagersScopedList > mutable_items();
 ...
 private:
  void operator=(const InstanceGroupManagerAggregatedList&);
};  // InstanceGroupManagerAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_AGGREGATED_LIST_H_
