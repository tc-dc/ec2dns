...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ROUTER_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_ROUTER_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class RouterAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static RouterAggregatedList* New();
   ...
   */
  explicit RouterAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RouterAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~RouterAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::RouterAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RouterAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<RoutersScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<RoutersScopedList > mutable_items();
 ...
 private:
  void operator=(const RouterAggregatedList&);
};  // RouterAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ROUTER_AGGREGATED_LIST_H_
