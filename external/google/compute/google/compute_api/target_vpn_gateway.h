...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_H_
#define  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_H_
 ...
 * @ingroup DataObject
 */
class TargetVpnGateway : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetVpnGateway(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetVpnGateway(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::TargetVpnGateway</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetVpnGateway");
  }
  ...
  const client::JsonCppArray<string > get_forwarding_rules() const {
     const Json::Value& storage = Storage("forwardingRules");
  ...
  client::JsonCppArray<string > mutable_forwardingRules() {
    Json::Value* storage = MutableStorage("forwardingRules");
  ...
  /**
   * Determine if the '<code>tunnels</code>' attribute was set.
   *
   * @return true if the '<code>tunnels</code>' attribute was set.
   */
  bool has_tunnels() const {
    return Storage().isMember("tunnels");
  }

  /**
   * Clears the '<code>tunnels</code>' attribute.
   */
  void clear_tunnels() {
    MutableStorage()->removeMember("tunnels");
  }


  /**
   * Get a reference to the value of the '<code>tunnels</code>' attribute.
   */
  const client::JsonCppArray<string > get_tunnels() const {
     const Json::Value& storage = Storage("tunnels");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<string > >(storage);
  }

  /**
   * Gets a reference to a mutable value of the '<code>tunnels</code>' property.
   *
  ...
  client::JsonCppArray<string > mutable_tunnels() {
    Json::Value* storage = MutableStorage("tunnels");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<string > >(storage);
  }

 private:
  void operator=(const TargetVpnGateway&);
};  // TargetVpnGateway
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAY_H_
