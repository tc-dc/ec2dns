...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_MACHINE_TYPE_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_MACHINE_TYPE_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class MachineTypeAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static MachineTypeAggregatedList* New();
   ...
   */
  explicit MachineTypeAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit MachineTypeAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~MachineTypeAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::MachineTypeAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::MachineTypeAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<MachineTypesScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<MachineTypesScopedList > mutable_items();
 ...
 private:
  void operator=(const MachineTypeAggregatedList&);
};  // MachineTypeAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_MACHINE_TYPE_AGGREGATED_LIST_H_
