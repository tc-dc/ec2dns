...
TargetPoolsAddInstanceRequest* TargetPoolsAddInstanceRequest::New() {
  return new client::JsonCppCapsule<TargetPoolsAddInstanceRequest>;
}

// Standard immutable constructor.
TargetPoolsAddInstanceRequest::TargetPoolsAddInstanceRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
TargetPoolsAddInstanceRequest::TargetPoolsAddInstanceRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
