...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_FORWARDING_RULE_LIST_H_
#define  GOOGLE_COMPUTE_API_FORWARDING_RULE_LIST_H_
 ...
 * @ingroup DataObject
 */
class ForwardingRuleList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ForwardingRuleList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ForwardingRuleList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ForwardingRuleList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::ForwardingRuleList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ForwardingRuleList");
  }
   ...
   */
  const client::JsonCppArray<ForwardingRule > get_items() const;
   ...
   */
  client::JsonCppArray<ForwardingRule > mutable_items();
 ...
 private:
  void operator=(const ForwardingRuleList&);
};  // ForwardingRuleList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_FORWARDING_RULE_LIST_H_
