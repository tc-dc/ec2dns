...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCES_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCES_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstancesScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class InstancesScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class InstancesScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static InstancesScopedListWarningData* New();
       ...
       */
      explicit InstancesScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit InstancesScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~InstancesScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return <code>google_compute_api::InstancesScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::InstancesScopedListWarningData");
      }
     ...
     private:
      void operator=(const InstancesScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static InstancesScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstancesScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstancesScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~InstancesScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_compute_api::InstancesScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::InstancesScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<InstancesScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<InstancesScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<InstancesScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<InstancesScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const InstancesScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static InstancesScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstancesScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstancesScopedList(Json::Value* storage);
   ...
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstancesScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstancesScopedList");
  }
   ...
   */
  const client::JsonCppArray<Instance > get_instances() const {
    const Json::Value& storage = Storage("instances");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<Instance>>(storage);
  }
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<Instance > mutable_instances();
  ...
  const InstancesScopedListWarning get_warning() const {
    ...
    return client::JsonValueToCppValueHelper<InstancesScopedListWarning >(storage);
  }
  ...
  InstancesScopedListWarning mutable_warning() {
    ...
    return client::JsonValueToMutableCppValueHelper<InstancesScopedListWarning >(storage);
  }

 private:
  void operator=(const InstancesScopedList&);
};  // InstancesScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCES_SCOPED_LIST_H_
