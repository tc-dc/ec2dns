...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SNAPSHOT_LIST_H_
#define  GOOGLE_COMPUTE_API_SNAPSHOT_LIST_H_
 ...
 * @ingroup DataObject
 */
class SnapshotList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SnapshotList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SnapshotList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::SnapshotList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SnapshotList");
  }
   ...
   */
  const client::JsonCppArray<Snapshot > get_items() const;
   ...
   */
  client::JsonCppArray<Snapshot > mutable_items();
 ...
 private:
  void operator=(const SnapshotList&);
};  // SnapshotList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SNAPSHOT_LIST_H_
