...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_SSL_CERTIFICATE_LIST_H_
#define  GOOGLE_COMPUTE_API_SSL_CERTIFICATE_LIST_H_
 ...
 * @ingroup DataObject
 */
class SslCertificateList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SslCertificateList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SslCertificateList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SslCertificateList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::SslCertificateList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::SslCertificateList");
  }
   ...
   */
  const client::JsonCppArray<SslCertificate > get_items() const;
   ...
   */
  client::JsonCppArray<SslCertificate > mutable_items();
 ...
 private:
  void operator=(const SslCertificateList&);
};  // SslCertificateList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_SSL_CERTIFICATE_LIST_H_
