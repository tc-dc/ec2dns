...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_HEALTH_CHECK_LIST_H_
#define  GOOGLE_COMPUTE_API_HEALTH_CHECK_LIST_H_
 ...
 * @ingroup DataObject
 */
class HealthCheckList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit HealthCheckList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit HealthCheckList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~HealthCheckList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::HealthCheckList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::HealthCheckList");
  }
   ...
   */
  const client::JsonCppArray<HealthCheck > get_items() const;
   ...
   */
  client::JsonCppArray<HealthCheck > mutable_items();
 ...
 private:
  void operator=(const HealthCheckList&);
};  // HealthCheckList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_HEALTH_CHECK_LIST_H_
