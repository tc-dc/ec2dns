...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGERS_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGERS_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupManagersScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class InstanceGroupManagersScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class InstanceGroupManagersScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static InstanceGroupManagersScopedListWarningData* New();
       ...
       */
      explicit InstanceGroupManagersScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit InstanceGroupManagersScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~InstanceGroupManagersScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return <code>google_compute_api::InstanceGroupManagersScopedListWarnin
       * gData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::InstanceGroupManagersScopedListWarningData");
      }
     ...
     private:
      void operator=(const InstanceGroupManagersScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static InstanceGroupManagersScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstanceGroupManagersScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit InstanceGroupManagersScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~InstanceGroupManagersScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return
     * <code>google_compute_api::InstanceGroupManagersScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::InstanceGroupManagersScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<InstanceGroupManagersScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<InstanceGroupManagersScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<InstanceGroupManagersScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<InstanceGroupManagersScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const InstanceGroupManagersScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static InstanceGroupManagersScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupManagersScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupManagersScopedList(Json::Value* storage);
   ...
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupManagersScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupManagersScopedList");
  }

  /**
   * Determine if the '<code>instanceGroupManagers</code>' attribute was set.
   *
   * @return true if the '<code>instanceGroupManagers</code>' attribute was set.
   */
  bool has_instance_group_managers() const {
    return Storage().isMember("instanceGroupManagers");
  }

  /**
   * Clears the '<code>instanceGroupManagers</code>' attribute.
   */
  void clear_instance_group_managers() {
    MutableStorage()->removeMember("instanceGroupManagers");
  }


  /**
   * Get a reference to the value of the '<code>instanceGroupManagers</code>'
   * attribute.
   */
  const client::JsonCppArray<InstanceGroupManager > get_instance_group_managers() const;

  /**
   * Gets a reference to a mutable value of the
   * '<code>instanceGroupManagers</code>' property.
   *
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<InstanceGroupManager > mutable_instanceGroupManagers();
  ...
  const InstanceGroupManagersScopedListWarning get_warning() const {
    ...
    return client::JsonValueToCppValueHelper<InstanceGroupManagersScopedListWarning >(storage);
  }
  ...
  InstanceGroupManagersScopedListWarning mutable_warning() {
    ...
    return client::JsonValueToMutableCppValueHelper<InstanceGroupManagersScopedListWarning >(storage);
  }

 private:
  void operator=(const InstanceGroupManagersScopedList&);
};  // InstanceGroupManagersScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGERS_SCOPED_LIST_H_
