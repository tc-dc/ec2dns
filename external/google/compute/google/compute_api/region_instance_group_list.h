...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_LIST_H_
#define  GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_LIST_H_
 ...
 * @ingroup DataObject
 */
class RegionInstanceGroupList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static RegionInstanceGroupList* New();
   ...
   */
  explicit RegionInstanceGroupList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RegionInstanceGroupList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~RegionInstanceGroupList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::RegionInstanceGroupList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RegionInstanceGroupList");
  }
   ...
   */
  const client::JsonCppArray<InstanceGroup > get_items() const;
   ...
   */
  client::JsonCppArray<InstanceGroup > mutable_items();
 ...
 private:
  void operator=(const RegionInstanceGroupList&);
};  // RegionInstanceGroupList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_REGION_INSTANCE_GROUP_LIST_H_
