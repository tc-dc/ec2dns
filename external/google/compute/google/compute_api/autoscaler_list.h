...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_AUTOSCALER_LIST_H_
#define  GOOGLE_COMPUTE_API_AUTOSCALER_LIST_H_
 ...
 * @ingroup DataObject
 */
class AutoscalerList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit AutoscalerList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AutoscalerList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~AutoscalerList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::AutoscalerList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::AutoscalerList");
  }
 ...
 private:
  void operator=(const AutoscalerList&);
};  // AutoscalerList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_AUTOSCALER_LIST_H_
