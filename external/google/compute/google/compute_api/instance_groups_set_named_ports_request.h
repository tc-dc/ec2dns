...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SET_NAMED_PORTS_REQUEST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SET_NAMED_PORTS_REQUEST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupsSetNamedPortsRequest : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceGroupsSetNamedPortsRequest* New();
   ...
   */
  explicit InstanceGroupsSetNamedPortsRequest(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupsSetNamedPortsRequest(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceGroupsSetNamedPortsRequest();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupsSetNamedPortsRequest</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupsSetNamedPortsRequest");
  }
 ...
 private:
  void operator=(const InstanceGroupsSetNamedPortsRequest&);
};  // InstanceGroupsSetNamedPortsRequest
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUPS_SET_NAMED_PORTS_REQUEST_H_
