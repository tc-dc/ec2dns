...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ROUTER_LIST_H_
#define  GOOGLE_COMPUTE_API_ROUTER_LIST_H_
 ...
 * @ingroup DataObject
 */
class RouterList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit RouterList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RouterList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::RouterList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::RouterList");
  }
   ...
   */
  const client::JsonCppArray<Router > get_items() const;
   ...
   */
  client::JsonCppArray<Router > mutable_items();
 ...
 private:
  void operator=(const RouterList&);
};  // RouterList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ROUTER_LIST_H_
