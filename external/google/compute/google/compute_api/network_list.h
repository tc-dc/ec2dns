...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_NETWORK_LIST_H_
#define  GOOGLE_COMPUTE_API_NETWORK_LIST_H_
 ...
 * @ingroup DataObject
 */
class NetworkList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit NetworkList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit NetworkList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::NetworkList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::NetworkList");
  }
   ...
   */
  const client::JsonCppArray<Network > get_items() const;
   ...
   */
  client::JsonCppArray<Network > mutable_items();
 ...
 private:
  void operator=(const NetworkList&);
};  // NetworkList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_NETWORK_LIST_H_
