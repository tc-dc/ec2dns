...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_INSTANCE_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_INSTANCE_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetInstanceList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TargetInstanceList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetInstanceList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~TargetInstanceList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetInstanceList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetInstanceList");
  }
   ...
   */
  const client::JsonCppArray<TargetInstance > get_items() const;
   ...
   */
  client::JsonCppArray<TargetInstance > mutable_items();
 ...
 private:
  void operator=(const TargetInstanceList&);
};  // TargetInstanceList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_INSTANCE_LIST_H_
