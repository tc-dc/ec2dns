...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_IMAGE_LIST_H_
#define  GOOGLE_COMPUTE_API_IMAGE_LIST_H_
 ...
 * @ingroup DataObject
 */
class ImageList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ImageList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ImageList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::ImageList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ImageList");
  }
   ...
   */
  const client::JsonCppArray<Image > get_items() const;
   ...
   */
  client::JsonCppArray<Image > mutable_items();
 ...
 private:
  void operator=(const ImageList&);
};  // ImageList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_IMAGE_LIST_H_
