...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_FORWARDING_RULE_AGGREGATED_LIST_H_
#define  GOOGLE_COMPUTE_API_FORWARDING_RULE_AGGREGATED_LIST_H_
 ...
 * @ingroup DataObject
 */
class ForwardingRuleAggregatedList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static ForwardingRuleAggregatedList* New();
   ...
   */
  explicit ForwardingRuleAggregatedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ForwardingRuleAggregatedList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ForwardingRuleAggregatedList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::ForwardingRuleAggregatedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::ForwardingRuleAggregatedList");
  }
   ...
   */
  const client::JsonCppAssociativeArray<ForwardingRulesScopedList > get_items() const;
   ...
   */
  client::JsonCppAssociativeArray<ForwardingRulesScopedList > mutable_items();
 ...
 private:
  void operator=(const ForwardingRuleAggregatedList&);
};  // ForwardingRuleAggregatedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_FORWARDING_RULE_AGGREGATED_LIST_H_
