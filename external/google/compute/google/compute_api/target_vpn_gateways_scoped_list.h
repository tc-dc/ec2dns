...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAYS_SCOPED_LIST_H_
#define  GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAYS_SCOPED_LIST_H_
 ...
 * @ingroup DataObject
 */
class TargetVpnGatewaysScopedList : public client::JsonCppData {
 public:
  /**
   ...
   * @ingroup DataObject
   */
  class TargetVpnGatewaysScopedListWarning : public client::JsonCppData {
   public:
    /**
     * No description provided.
     *
     * @ingroup DataObject
     */
    class TargetVpnGatewaysScopedListWarningData : public client::JsonCppData {
     public:
      /**
       ...
       */
      static TargetVpnGatewaysScopedListWarningData* New();
       ...
       */
      explicit TargetVpnGatewaysScopedListWarningData(const Json::Value& storage);
       ...
       * @param[in] storage  The underlying data storage for this instance.
       */
      explicit TargetVpnGatewaysScopedListWarningData(Json::Value* storage);

      /**
       * Standard destructor.
       */
      virtual ~TargetVpnGatewaysScopedListWarningData();

      /**
       * Returns a string denoting the type of this data object.
       *
       * @return
       * <code>google_compute_api::TargetVpnGatewaysScopedListWarningData</code>
       */
      const StringPiece GetTypeName() const {
        return StringPiece("google_compute_api::TargetVpnGatewaysScopedListWarningData");
      }
     ...
     private:
      void operator=(const TargetVpnGatewaysScopedListWarningData&);
     ...
     * @return Ownership is passed back to the caller.
     */
    static TargetVpnGatewaysScopedListWarning* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit TargetVpnGatewaysScopedListWarning(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit TargetVpnGatewaysScopedListWarning(Json::Value* storage);

    /**
     * Standard destructor.
     */
    virtual ~TargetVpnGatewaysScopedListWarning();

    /**
     * Returns a string denoting the type of this data object.
     *
     * @return
     * <code>google_compute_api::TargetVpnGatewaysScopedListWarning</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_compute_api::TargetVpnGatewaysScopedListWarning");
    }
     ...
     */
    const client::JsonCppArray<TargetVpnGatewaysScopedListWarningData > get_data() const {
       const Json::Value& storage = Storage("data");
      return client::JsonValueToCppValueHelper<client::JsonCppArray<TargetVpnGatewaysScopedListWarningData > >(storage);
    }
     ...
     */
    client::JsonCppArray<TargetVpnGatewaysScopedListWarningData > mutable_data() {
      Json::Value* storage = MutableStorage("data");
      return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<TargetVpnGatewaysScopedListWarningData > >(storage);
    }
   ...
   private:
    void operator=(const TargetVpnGatewaysScopedListWarning&);
   ...
   * @return Ownership is passed back to the caller.
   */
  static TargetVpnGatewaysScopedList* New();
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetVpnGatewaysScopedList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TargetVpnGatewaysScopedList(Json::Value* storage);
   ...
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::TargetVpnGatewaysScopedList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::TargetVpnGatewaysScopedList");
  }

  /**
   * Determine if the '<code>targetVpnGateways</code>' attribute was set.
   *
   * @return true if the '<code>targetVpnGateways</code>' attribute was set.
   */
  bool has_target_vpn_gateways() const {
    return Storage().isMember("targetVpnGateways");
  }

  /**
   * Clears the '<code>targetVpnGateways</code>' attribute.
   */
  void clear_target_vpn_gateways() {
    MutableStorage()->removeMember("targetVpnGateways");
  }


  /**
   * Get a reference to the value of the '<code>targetVpnGateways</code>'
   * attribute.
   */
  const client::JsonCppArray<TargetVpnGateway > get_target_vpn_gateways() const;

  /**
   * Gets a reference to a mutable value of the '<code>targetVpnGateways</code>'
   * property.
   *
   ...
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<TargetVpnGateway > mutable_targetVpnGateways();
  ...
  const TargetVpnGatewaysScopedListWarning get_warning() const {
    ...
    return client::JsonValueToCppValueHelper<TargetVpnGatewaysScopedListWarning >(storage);
  }
  ...
  TargetVpnGatewaysScopedListWarning mutable_warning() {
    ...
    return client::JsonValueToMutableCppValueHelper<TargetVpnGatewaysScopedListWarning >(storage);
  }

 private:
  void operator=(const TargetVpnGatewaysScopedList&);
};  // TargetVpnGatewaysScopedList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_TARGET_VPN_GATEWAYS_SCOPED_LIST_H_
