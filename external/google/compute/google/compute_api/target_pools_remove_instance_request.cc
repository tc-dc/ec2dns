...
TargetPoolsRemoveInstanceRequest* TargetPoolsRemoveInstanceRequest::New() {
  return new client::JsonCppCapsule<TargetPoolsRemoveInstanceRequest>;
}

// Standard immutable constructor.
TargetPoolsRemoveInstanceRequest::TargetPoolsRemoveInstanceRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
TargetPoolsRemoveInstanceRequest::TargetPoolsRemoveInstanceRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
