...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_ADDRESS_LIST_H_
#define  GOOGLE_COMPUTE_API_ADDRESS_LIST_H_
 ...
 * @ingroup DataObject
 */
class AddressList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit AddressList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AddressList(Json::Value* storage);
   ...
   *
   * @return <code>google_compute_api::AddressList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::AddressList");
  }
   ...
   */
  const client::JsonCppArray<Address > get_items() const;
   ...
   */
  client::JsonCppArray<Address > mutable_items();
 ...
 private:
  void operator=(const AddressList&);
};  // AddressList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_ADDRESS_LIST_H_
