...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_LIST_H_
#define  GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_LIST_H_
 ...
 * @ingroup DataObject
 */
class InstanceGroupManagerList : public client::JsonCppData {
 public:
  /**
   ...
   */
  static InstanceGroupManagerList* New();
   ...
   */
  explicit InstanceGroupManagerList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit InstanceGroupManagerList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~InstanceGroupManagerList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::InstanceGroupManagerList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::InstanceGroupManagerList");
  }
 ...
 private:
  void operator=(const InstanceGroupManagerList&);
};  // InstanceGroupManagerList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_INSTANCE_GROUP_MANAGER_LIST_H_
