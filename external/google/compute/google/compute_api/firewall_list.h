...
//     C++: 0.1.4
#ifndef  GOOGLE_COMPUTE_API_FIREWALL_LIST_H_
#define  GOOGLE_COMPUTE_API_FIREWALL_LIST_H_
 ...
 * @ingroup DataObject
 */
class FirewallList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit FirewallList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit FirewallList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~FirewallList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_compute_api::FirewallList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_compute_api::FirewallList");
  }
   ...
   */
  const client::JsonCppArray<Firewall > get_items() const;
   ...
   */
  client::JsonCppArray<Firewall > mutable_items();
 ...
 private:
  void operator=(const FirewallList&);
};  // FirewallList
}  // namespace google_compute_api
#endif  // GOOGLE_COMPUTE_API_FIREWALL_LIST_H_
